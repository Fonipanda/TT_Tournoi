...
class Match(models.Model):
    ...
    player2 = models.ForeignKey(Player, on_delete=models.CASCADE, null=True, blank=True, related_name='matches_as_player2')
    ...
    forfeit_player = models.ForeignKey(Player, on_delete=models.SET_NULL, null=True, blank=True, related_name='forfeit_matches')
